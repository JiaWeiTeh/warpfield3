...
import src.warpfield.phase_general.set_phase as set_phase
...
def run_momentum(t0, y0, 
    ...
    while tStop_i < warpfield_params.stop_t and v0 > warpfield_params.stop_v and\
        ...
        phase1 = set_phase.set_phase(r[-1], rCore, rCloud, tStop_i,  rd[-1], dens_grad=warpfield_params.density_gradient)[0]
        if phase0 != phase1:
            phase = set_phase.set_phase(r, rCore, rCloud, t0,  rd, dens_grad=warpfield_params.density_gradient)

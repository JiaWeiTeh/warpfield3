...
This script reads in parameter file and passes it to WARPFIELD. This script
will also create a summary.txt file for output. 

To use, simple call python3 src/input_tools/read_param param/example.param [TBD]
"""
...
# Then, organize dictionary so that it does not include useless info
...
# Remove unrelated parameters depending on random input
if params_dict['rand_input'][0] == '0':
